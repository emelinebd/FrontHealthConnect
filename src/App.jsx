      ...
      <div className="App">
        <header className="App-header">
          ...
          <nav>
            <ul>
              ...
              <li>
                <Link to="/prise-de-rendez-vous">Prise de rendez-vous</Link>
              </li>
              <li>
                <Link to="/suivi-des-rendez-vous">Suivi des rendez-vous</Link>
              </li>
              <li>
                <Link to="/dossiers-medicaux">
                  Dossiers médicaux électroniques
                </Link>
              </li>
              <li>
                <Link to="/ressources-sante">Ressources santé</Link>
              </li>
            </ul>
          </nav>
        </header>
        <main>
          <Routes>
            ...
            />
            <Route
              path="/suivi-des-rendez-vous"
              element={<SuiviDesRendezVous />}
            />
